...
import com.autoai.firstdevelopmet.payment.functionmodels.gasolinepayment.adapter.SmartAddGasStationListAdapter;
import com.autoai.firstdevelopmet.payment.functionmodels.gasolinepayment.adapter.SmartPopSelectAdapter;
...
public class SmartAddGasolineFragment extends BaseMvpFragment<SmartAddGasolinePresenter> implements SmartAddGosolineContract.View {
    ...
    private void showPopupWindow(List<String> dates){
        if (mSmartSelectPop == null){
            ...
            mSmartSelectPop = new PopupWindow(contentView, LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT, true);
